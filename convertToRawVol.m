function convert_raw_volume(cellCount, channelCount, baseline_noise, protein_noise, protein_density, expansion_factor)
    ...
    save(['/Users/min-hwan/Documents/Brainbow/bbSimulation/simData/sims_' num2str(channelCount) 'ch_' num2str(baseline_noise) 'bn_' num2str(protein_noise) 'pn_' num2str(protein_density) 'pd_' expansion_factor 'ef_raw.mat'], 'overallRawVolume', 'volumeLabels','colorMatrix');
end