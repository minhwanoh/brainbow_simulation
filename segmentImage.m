...
%superVoxelOpts.dataset = '/Users/min-hwan/Documents/Brainbow/bbSimulation/simData/sim_5cells_ch4_denoised.mat';
%superVoxelOpts.filePreamble = '/Users/min-hwan/Documents/Brainbow/bbSimulation/simData/sim_5cells_ch4_6conn_denoised_ws0.01_isplit0.5_20_augmented0.1';
denoisedFilename = ['/Users/min-hwan/Documents/Brainbow/bbSimulation/simData/sim_5cells_ch4_denoised.mat'];
%load(superVoxelOpts.dataset);
load(denoisedFilename);
bbVol = denoised;
clear denoised;
bbVol(bbVol<0)=0;
